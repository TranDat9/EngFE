  ...
  return (
    <div className='overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
      <div className='relative z-20 h-35 md:h-65'>
        <img
          src={
            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6m9z4_mG0Wb0iJzPzZx7G2ZQsej0JvJEmgQYCuHN9aA&s'
          }
          alt='profile cover'
      ...
      <div className='px-4 pb-6 text-center lg:pb-8 xl:pb-11.5'>
        ...
        <div className='mt-4'>
          <h3 className='mb-1.5 text-2xl font-semibold text-black dark:text-white'>{dataUser.name}</h3>
